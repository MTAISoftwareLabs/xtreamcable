...
function OperationalPage({ page, meta, data, isReseller, onAction, navigate, showToast, refreshData }) {
  ...
  const actionLabel = isResellers ? 'Add reseller' : (isCredits && !isReseller) ? 'Transfer credits' : isLiveTv ? 'Add content' : isMovies ? 'Add movie' : isSeries ? 'Add series' : page === 'users' ? 'Add user' : page === 'user-groups' ? 'Add group' : page === 'packages' ? 'Add package' : isCategory ? 'Add category' : isEpg ? 'Add schedule' : isServer ? 'Add server' : isSource ? 'Add source' : null
