  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="metric-grid">
        ...
        <MetricCard label="Online streams" value={metrics.activeStreams || 0} meta="Tracked playback sessions" icon={Radio} tone="green" />
